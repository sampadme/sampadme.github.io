<?php if(Settings('preloader_status')): ?>
    <?php if(Settings('preloader_type')==2): ?>
        <div class="preloader" dir="ltr" >
            <img style="width: 200px" src="<?php echo e(asset(Settings('preloader_image'))); ?>" alt="">
        </div>
    <?php else: ?>
        <?php if(!Settings('preloader_style')||Settings('preloader_style')==0): ?>
          ...
          <span>
            ...
            <span></span>
                ...
                <h1><?php echo e(__('frontend.Loading')); ?> ...</h1>
            </div>
        <?php elseif(Settings('preloader_style')==1): ?>
            <div class="preloader" dir="ltr">
                <div class="circle circle1"></div>
            </div>
        <?php elseif(Settings('preloader_style')==2): ?>


            <div class="preloader" dir="ltr">
                <div class="circle circle2"></div>
            </div>
        <?php elseif(Settings('preloader_style')==3): ?>
            <div class="preloader" dir="ltr">
                <div class="circle circle3 c31"></div>
                <div class="circle circle3 c32"></div>
            </div>
        <?php elseif(Settings('preloader_style')==4): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(Settings('preloader_style')==5): ?>
            <div class="preloader" dir="ltr">
                <div class="circle circle5 c51"></div>
            </div>
        <?php elseif(Settings('preloader_style')==6): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(Settings('preloader_style')==7): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(Settings('preloader_style')==8): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(Settings('preloader_style')==9): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(Settings('preloader_style')==10): ?>
            <div class="preloader" dir="ltr">
        ...
        <?php elseif(Settings('preloader_style')==11): ?>
        ...
        <?php elseif(Settings('preloader_style')==12): ?>
        ...
        <?php elseif(Settings('preloader_style')==13): ?>

            <div class="preloader" dir="ltr">
                <div class="circle circle13 c131"></div>
            </div>
        <?php elseif(Settings('preloader_style')==14): ?>

            <div class="preloader" dir="ltr">
                <div class="circle circle14 c141"></div>
            </div>
        <?php elseif(Settings('preloader_style')==15): ?>

            <div class="preloader" dir="ltr">
                <div class="circle circle15 c151"></div>
            </div>
        <?php elseif(Settings('preloader_style')==16): ?>
        ...
        <?php elseif(Settings('preloader_style')==17): ?>
        ...
        <?php elseif(Settings('preloader_style')==18): ?>

            <div class="preloader" dir="ltr">
                <div class="dot dot3"></div>
                <div class="dot dot3 dot31"></div>
            </div>
        <?php elseif(Settings('preloader_style')==19): ?>

            <div class="preloader" dir="ltr">
                <div class="dot dot4"></div>
                <div class="dot dot4 dot41"></div>
            </div>
        <?php elseif(Settings('preloader_style')==20): ?>
        ...
        <?php elseif(Settings('preloader_style')==21): ?>
        ...
        <?php elseif(Settings('preloader_style')==22): ?>
        ...
        <?php elseif(Settings('preloader_style')==23): ?>
        ...
        <?php elseif(Settings('preloader_style')==24): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/preloader.blade.php ENDPATH**/ ?>