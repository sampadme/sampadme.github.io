<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/categories/3.jpg')); ?>"
    ...
    <style>
        ...
        .category-item {
            ...
            background: linear-gradient(180deg, var(--system_primery_color_0) 0%, var(--system_primery_color) 50%, var(--system_primery_color) 100%);
        ...
        .category-item-icon {
            background: linear-gradient(180deg, var(--system_primery_color) 0%, var(--sytem_gradient_2) 100%) !important;
        }
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_category-v5.blade.php ENDPATH**/ ?>