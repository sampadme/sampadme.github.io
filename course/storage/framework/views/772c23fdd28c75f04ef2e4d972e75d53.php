<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/course/featured.jpg')); ?>"
    ...
    <section class="featured bg-white">
        <div class="featured-inner">
            <div data-type="component-nonExisting"
                 data-preview=""
                 data-table=""
                 data-select="id,type,slug,title,thumbnail,price,discount_price,mode_of_delivery,duration,total_enrolled,user_id,category_id,level,total_rating,about"
                 data-order="id"
                 data-limit="6"
                 data-where-status="1"
                 data-where-type="1"
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_course_section_featured.blade.php ENDPATH**/ ?>