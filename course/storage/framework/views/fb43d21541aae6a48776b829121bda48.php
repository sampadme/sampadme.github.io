<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/course/3.jpg')); ?>"
                ...
                <div class="col-lg-12">
                    <div class="section-subtitle">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                <h3 class="mb-0 text-white"><?php echo e(@$homeContent->course_title); ?></h3>
                            </div>
                            <div class="section-subtitle-action">
                                <a href="<?php echo e(route('courses')); ?>" class="theme-btn bg-white ms-2">All Course</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_course_section_dark.blade.php ENDPATH**/ ?>