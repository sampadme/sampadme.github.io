    ...
    <section class="admin-visitor-area student-details">
        <div class="container-fluid p-0">
            <div class="row">
                ...
                <?php endif; ?>
                <div class="<?php if($course->type == 1): ?> col-md-12 <?php else: ?> col-md-12 <?php endif; ?> ">
                    <div class="main-title">
                        <h3 class="">

                            <?php echo e(__('courses.Course')); ?> | <a target="_blank"
                                                            href="<?php echo e(courseDetailsUrl(@$course->id, @$course->type, @$course->slug)); ?>"><?php echo e($course->title); ?></a>
                        </h3>
                    </div>
                    ...
                    <div class="row pt-0">
                        <ul class="nav nav-tabs no-bottom-border  mt-sm-md-20 mb-10 ms-3" role="tablist">
                            <?php if($course->type == 1): ?>
                                <li class="nav-item">
                                    <a class="nav-link <?php if($type == 'courses'): ?> active <?php endif; ?>"
                                       href="#group_email_sms" role="tab"
                                       data-bs-toggle="tab"><?php echo e(__('courses.Course')); ?>

                                        <?php echo e(__('courses.Curriculum')); ?> </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link  <?php if($type == 'courseDetails'): ?> active <?php endif; ?> "
                                       href="#indivitual_email_sms" role="tab"
                                       data-bs-toggle="tab"><?php echo e(__('courses.Course')); ?> <?php echo e(__('common.Details')); ?></a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link  <?php if($type == 'files'): ?> active <?php endif; ?>" href="#file_list"
                                       role="tab" data-bs-toggle="tab"><?php echo e(__('courses.Exercise')); ?>

                                        <?php echo e(__('common.Files')); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  <?php if($type == 'certificate'): ?> active <?php endif; ?>" href="#certificate"
                                       role="tab" data-bs-toggle="tab"><?php echo e(__('certificate.Certificate')); ?></a>
                                </li>
                                <?php if($course->drip == 1): ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?php if($type == 'drip'): ?> active <?php endif; ?>" href="#drip"
                                           role="tab" data-bs-toggle="tab"> <?php echo e(__('common.Drip Content')); ?></a>
                                    </li>
                                <?php endif; ?>

                                <?php if(isModuleActive('EarlyBird') && $course_price>0): ?>
                                    <li class="nav-item">
                                        <a class="nav-link <?php if($type == 'earlyBirdPrice'): ?> active <?php endif; ?>"
                                           href="#earlyBirdPrice"
                                           role="tab" data-bs-toggle="tab"> <?php echo e(__('price_plan.Price Plan')); ?></a>
                                    </li>
                                <?php endif; ?>
                            <?php endif; ?>
                        ...
                        <div class="row  mt_0_sm">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <?php if ($__env->exists('coursesetting::parts_of_course_details._course_details_carriclum_tab')) echo $__env->make('coursesetting::parts_of_course_details._course_details_carriclum_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php if ($__env->exists('coursesetting::parts_of_course_details._course_details_tab')) echo $__env->make('coursesetting::parts_of_course_details._course_details_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php if ($__env->exists('coursesetting::parts_of_course_details._course_details_exercise_file_tab')) echo $__env->make('coursesetting::parts_of_course_details._course_details_exercise_file_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php if ($__env->exists('coursesetting::parts_of_course_details._course_details_certificate_tab')) echo $__env->make('coursesetting::parts_of_course_details._course_details_certificate_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php if ($__env->exists('coursesetting::parts_of_course_details._course_details_drip_tab')) echo $__env->make('coursesetting::parts_of_course_details._course_details_drip_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php if ($__env->exists('coursesetting::parts_of_course_details._course_details_early_bird_tab')) echo $__env->make('coursesetting::parts_of_course_details._course_details_early_bird_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if(isModuleActive('Org')): ?>
            ...
            <div class="modal-dialog  modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php echo e(__('org.Select Material')); ?></h4>
                                ...
                                <div class="col-xl-12">
                                    <div class="input-effect mt-2 pt-1">
                                        <select class="primary_select AddSelectCateogry"
                                                name="category">
                                            <option
                                                data-display="<?php echo e(__('common.Select')); ?> <?php echo e(__('org.Category')); ?>"
                                                value=""><?php echo e(__('common.Select')); ?> <?php echo e(__('org.Category')); ?> </option>
                                    ...
                                    <div class="input-effect mt-2 pt-1">
                                        <select class="primary_select "
                                                ...
                                                id="AddSelectFile">
                                            <option
                                                data-display="<?php echo e(__('common.Select')); ?> <?php echo e(__('org.File')); ?>"
                                                value=""><?php echo e(__('common.Select')); ?> <?php echo e(__('org.File')); ?> </option>
        ...
        <div class="modal fade admin-query" id="orgNewFileSelect">
            <div class="modal-dialog modal_700px modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php echo e(__('org.Add New Material')); ?></h4>
                        <button type="button" class="close " data-bs-dismiss="modal">
                            <i class="ti-close "></i>
                        </button>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for=""><?php echo e(__('org.Category')); ?> <strong
        ...
        <?php $__env->startPush('scripts'); ?>
            ...
            <script>
                ...
                $(document).on('change click', '#MaterialFileInsert', function (e) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(route('org.ajaxMaterialSourceGet')); ?>",
                        data: formData,
                ...
                $(document).on('change click', '#MaterialFileSave', function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('org.ajaxMaterialSourceSave')); ?>",
                        ...
                        success: function (data) {
                            if (data != "" && data.link != 'undefined' && data.link != '') {
                                ...
                                toastr.error("<?php echo e(trans('org.File Upload Failed')); ?>", '<?php echo e(trans('common.Error')); ?>');
                                return false;
                            }
                        }
                    });
                ...
                $(document).on('change', '.AddSelectCateogry', function (e) {
                    ...
                    var url = "<?php echo e(route('org.getFilesByCategory')); ?>";
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(asset('/')); ?>/Modules/CourseSetting/Resources/assets/js/advance_search.js"></script>
        ...
        $('.nastable').sortable({
            ...
            update: function (event, ui) {
                ...
                if (ids.length > 0) {
                    ...
                    $.get("<?php echo e(route('changeChapterPosition')); ?>", data, function (data) {
        ...
        $('.nastable2').sortable({
            ...
            update: function (event, ui) {
                ...
                if (ids.length > 0) {
                    ...
                    $.post("<?php echo e(route('changeLessonPosition')); ?>", data, function (data) {
            ...
            receive: function (event, ui) {
                ...
                $.post("<?php echo e(route('changeLessonChapter')); ?>", data, function (data) {
    ...
    <script>
        ...
        function getBunnyListForLesson() {
            $('.BunnyVideoLesson').select2({
                ajax: {
                    url: '<?php echo e(route('bunny_stream.get_lesson')); ?>',
                    type: "GET",
                    dataType: 'json',
                    delay: 250,
        ...
        $(document).ready(function () {
            ...
            if (host == 'Vimeo') {
                ...
                if (uri != "") {
                    $.ajax({
                        url: "<?php echo e(url('admin/course/vimeo/video')); ?>?uri=" + uri,
                        success: function (data) {
                ...
                if (id != "") {
                    $.ajax({
                        url: "<?php echo e(url('admin/course/vdocipher/video')); ?>/" + id,
                        success: function (data) {
            ...
            $('.VdoCipherVideoLesson').each(function (i, obj) {
                ...
                if (host == 'VdoCipher') {
                    ...
                    if (lessonId != "") {
                        $.ajax({
                            url: "<?php echo e(url('admin/course/vdocipher/video')); ?>/" + lessonId,
                            success: function (data) {
            ...
            $('.vimeoVideoLesson').each(function (i, obj) {
                ...
                if (host == 'Vimeo') {
                    ...
                    if (lessonUri != "") {
                        $.ajax({
                            url: "<?php echo e(url('admin/course/vimeo/video')); ?>?uri=" + lessonUri,
                            success: function (data) {
        ...
        var editLesson = $('#category_id_edit_<?php echo e($editLesson->id); ?>');
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/sampad.me/public_html/course/Modules/CourseSetting/Providers/../Resources/views/course_details.blade.php ENDPATH**/ ?>