    ...
    <div class="add-visitor">
        <div class="input-effect mt-2 pt-1 mb-20">
            ...
            <input
                ...
                autocomplete="off"
                value="<?php echo e(isset($editChapter)? $editChapter->name:''); ?>">
            <input type="hidden" name="chapter"
                   value="<?php echo e(isset($editChapter)? $editChapter->id: ''); ?>">
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/Modules/CourseSetting/Providers/../Resources/views/parts_of_course_details/chapter_section.blade.php ENDPATH**/ ?>