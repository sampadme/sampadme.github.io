<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/apk/3.jpg')); ?>"
        ...
        <div class="container">
            <div class="row align-items-center">
                    ...
                    <div class="apk-content">
                        ...
                        <div class="d-flex align-items-center gap-4">
                            <a href="#" target="_blank">
                                <img src="<?php echo e(url('public/frontend/infixlmstheme/img/svg/google_play_btn.svg')); ?>"
                                     alt=""> </a>
                            <a href="#" target="_blank">
                                <img src="<?php echo e(url('public/frontend/infixlmstheme/img/svg/apple_store_btn.svg')); ?>"
                                     alt="">
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 text-center">
                    <div class="apk-img">
                        <img src="<?php echo e(themeAsset('img/others/apk-img-v2.png')); ?>" alt="">
                    </div>
                </div>
            </div>
                    ...
                    <div class="apk-skill-card">
                        <div class="row">
                            <div class="col-md-7 col-lg-8">
                                ...
                                <div class="apk-skill-img d-none d-sm-block"><img src="<?php echo e(themeAsset('img/others/apk-card-1.png')); ?>" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="apk-skill-card">
                        <div class="row">
                            <div class="col-md-7 col-lg-8">
                                ...
                                <h3>Level - Up Your Raw Coding <br> Skills in Lockdown</h3>
                                <a href="#" class="theme-btn">Find Out More</a>
                                <div class="apk-skill-img d-none d-sm-block"><img src="<?php echo e(themeAsset('img/others/apk-card-2.png')); ?>" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_apk_section_v3.blade.php ENDPATH**/ ?>