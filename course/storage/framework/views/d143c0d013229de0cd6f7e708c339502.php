    ...
    <form action="<?php echo e(route('search')); ?>">
        <div class="banner-area">
            <div class="banner-img d-none d-md-block">
                <img src="<?php echo e(asset('public/frontend/infixlmstheme/img/banner/banner-v6.png')); ?>" alt="">
            </div>
            <div class="banner-free d-none d-lg-flex align-items-center">
                <div class="icon">
                    <img src="<?php echo e(themeAsset('img/shape/laptop-star.png')); ?>" alt="">
                </div>
                <div class="content">
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_banner-light.blade.php ENDPATH**/ ?>