                                ...
                                <div class="row justify-content-between">
                                    <div class="col-lg-12 p-5">
                                        <div class="contact_title">
                                            <h4 class="mb-0"><?php echo e(__('certificate.Verify Certificate')); ?></h4>
                                            <div class="subcribe-form theme_mailChimp mt-40">
                                                <form action="#"
                                                      method="GET" class="subscription relative">
                                                    <input name="certificate_number" class="primary_input"
                                                           placeholder="<?php echo e(__('certificate.Enter Certificate Number')); ?>"
                                                           onfocus="this.placeholder = ''"
                                                           onblur="this.placeholder = '<?php echo e(__('certificate.Enter Certificate Number')); ?>'"
                                                           required="" type="text"
                                                           value="<?php echo e(old('certificate_number')); ?>">

                                                    <button id="getCertificate"
                                                            type="button"><?php echo e(__('chat.search')); ?></button>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/pages/certificate-verification.blade.php ENDPATH**/ ?>