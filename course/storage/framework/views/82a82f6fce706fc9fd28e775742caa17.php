<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/apk/2.jpg')); ?>"
    ...
    <div class="container">
        <div class="apk position-relative">
            <div class="apk-shape position-absolute">
                <img src="<?php echo e(themeAsset('img/shape/reward-shape.png')); ?>" alt="">
            </div>
                ...
                <div class="col-lg-6">
                    <div class="apk-img mx-auto">
                        <div class="overflow-hidden">
                            <img src="<?php echo e(themeAsset('img/others/phone-img.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_apk_section_v2.blade.php ENDPATH**/ ?>