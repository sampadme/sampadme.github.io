<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/about/4.jpg')); ?>"
                ...
                <div class="col-md-12">
                    ...
                    <div class="about-inner position-relative">
                        <div class="about-inner-overlay-img position-absolute"><img
                                src="<?php echo e(themeAsset('img/others/about-child.png')); ?>" alt=""></div>
                        <div class="row g-0 align-items-center">
                            <div class="col-lg-5">
                                <div class="about-video position-relative">
                                    <img src="<?php echo e(themeAsset('img/others/video-preview.jpg')); ?>" alt="alt img">
                            ...
                            <div class="col-lg-7">
                                <div class="about-content ps-lg-4">
                                    ...
                                    <a href="<?php echo e(url('about-us')); ?>" class="theme-btn">Know More</a>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_about_v4.blade.php ENDPATH**/ ?>