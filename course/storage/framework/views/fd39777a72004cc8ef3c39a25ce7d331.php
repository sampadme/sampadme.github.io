            ...
            <div class="newsletter_form_wrapper newsletter_active" id="popupContentModal">
                <div class="newsletter_form_inner">
                    ...
                    <div class="newsletter_form">
                        <h3 class="text-left"><?php echo e($popup->title); ?></h3>
                        <p class="text-start">
                        ...
                        <div class="row">
                            <div class="col-12 mt-10">
                                <a href="<?php echo e($popup->link); ?>"
                                   class="theme_btn text-center"> <?php echo e($popup->btn_txt); ?></a>
                            </div>
                        </div>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/components/popup-content.blade.php ENDPATH**/ ?>