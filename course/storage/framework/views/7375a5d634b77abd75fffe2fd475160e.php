<div data-type="component-nonExisting"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/home/home_sponsor_v2.jpg')); ?>"
...
>
    <style>
        ...
        .about-inner {
            background: rgba(0, 0, 0, 0.86) url('<?php echo e(asset('public/frontend/infixlmstheme/img/shape/about-bg-shape.png')); ?>') no-repeat center;
            padding: 80px 0px
        }
                ...
                <div class="col-sm-12 col-lg-6 text-center">
                    <div class="about-inner">
                        ...
                        <div class="about-video position-relative">
                            <img src="<?php echo e(themeAsset('img/others/about-v3.png')); ?>" alt="">
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_home_sponsor_success.blade.php ENDPATH**/ ?>