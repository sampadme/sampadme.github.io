<div data-type="component-text"
    ...
    <div class="instrucotr position-relative bg-white">
        <div class="instrucotr-shape"><img src="<?php echo e(themeAsset('img/shape/team-shape.png')); ?>" alt=""></div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <div class="section-title">
                        <h2><?php echo e(__('frontend.Expert Teachers')); ?></h2>
                        <p><?php echo e(__('frontend.Here is short details about our institute, Also you can see how we work')); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_popular_instructors_v5.blade.php ENDPATH**/ ?>