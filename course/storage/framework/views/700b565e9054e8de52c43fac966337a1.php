...
<input type="hidden" name="lesson_id" value="<?php echo e(@$editLesson->id); ?>">
        ...
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="col-xl-6 ">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="radio" class="common-radio type1" data-key="<?php echo e(@$key); ?>"
                                           id="type<?php echo e(@$course->id); ?>1<?php echo e(@$key); ?>" name="type"
                                           value="1" checked>
                                    <label
                                        for="type<?php echo e(@$course->id); ?>1<?php echo e(@$key); ?>"><?php echo e(__('quiz.Existing')); ?></label>
                                </div>
                                <div class="col-md-6">
                                    <input type="radio" data-key="<?php echo e(@$key); ?>" class="common-radio type2"
                                           id="type<?php echo e(@$course->id); ?>2<?php echo e(@$key); ?>" name="type"
                                           value="2">
                                    <label
                                        for="type<?php echo e(@$course->id); ?>2<?php echo e(@$key); ?>"><?php echo e(__('quiz.New')); ?></label>
                                </div>
                            </div>
                ...
                <strong><?php echo e($errors->first('quiz')); ?></strong>
                    ...
                    <div class="input-effect mt-2 pt-1" id="existing_quiz<?php echo e(@$key); ?>">
                        <label class="primary_input_label mt-1"
                               for=""> <?php echo e(__('quiz.Quiz')); ?> <span class="required_mark">*</span></label>
                ...
                <strong><?php echo e($errors->first('quiz')); ?></strong>
                    ...
                    <div class="mt-20" id="new_quiz<?php echo e(@$key); ?>" style="display: none">
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/Modules/CourseSetting/Providers/../Resources/views/parts_of_course_details/quiz_section_inside.blade.php ENDPATH**/ ?>