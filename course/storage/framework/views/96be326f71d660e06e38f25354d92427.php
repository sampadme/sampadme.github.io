<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/quiz/4.jpg')); ?>"
                ...
                <div class="col-lg-12">
                    <div class="section-subtitle">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                <h3 class="mb-0 text-white"><?php echo e(@$homeContent->quiz_title); ?></h3>
                            </div>
                            <div class="section-subtitle-action mt-0">
                                <a href="<?php echo e(route('quizzes')); ?>" class="theme-btn bg-white ms-2">All Quiz</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_quiz_section_v4.blade.php ENDPATH**/ ?>