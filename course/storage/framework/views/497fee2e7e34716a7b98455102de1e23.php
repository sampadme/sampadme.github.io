    ...
    <?php if($cookie): ?>
        ...
        <div class="theme_cookies" style="display: none">
            <div class="theme_cookies_info flex-fill">
                ...
                <p><?php echo @$cookie->details; ?>

                </p>
                <button type="button" class="cookie_btn" onclick="setCookies(1);"><?php echo e(@$cookie->btn_text); ?></button>
                <button type="button" class="cookie_btn" data-bs-toggle="modal"
                        data-bs-target="#cookieSettingsModal"><?php echo e(@$cookie->customize_btn_text); ?></button>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalToggleLabel"><?php echo e(__('setting.GDPR')); ?></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <?php echo @$cookie->gdpr_details; ?>
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center mb-2">
                                            <label class="primary_checkbox d-flex mb-0">
                                                ...
                                                <span class="label_name"><?php echo e(__('setting.Strictly Necessary')); ?></span>
                                            </label>
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center mb-2">
                                            <label class="primary_checkbox d-flex mb-0">
                                                ...
                                                <span class="checkmark mr_15"></span>
                                                <span class="label_name"><?php echo e(__('setting.Performance Cookies')); ?></span>
                                            </label>
                                            <i class="far fa-question-circle ms-2" style="cursor: pointer"
                                               onclick="displayCookieSettingDetails(this)"></i>
                                        </div>
                                        <p class="height-none cookie-setting-details my-3">
                                            <?php echo @$cookie->gdpr_performance; ?>
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center mb-2">
                                            <label class="primary_checkbox d-flex mb-0">
                                                ...
                                                <span class="checkmark mr_15"></span>
                                                <span class="label_name"><?php echo e(__('setting.Functional Cookies')); ?></span>
                                            </label>
                                            <i class="far fa-question-circle ms-2" style="cursor: pointer"
                                               onclick="displayCookieSettingDetails(this)"></i>
                                        </div>
                                        <p class="height-none cookie-setting-details my-3">
                                            <?php echo @$cookie->gdpr_functional; ?>
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center mb-2">
                                            <label class="primary_checkbox d-flex mb-0">
                                                ...
                                                <span class="checkmark mr_15"></span>
                                                <span class="label_name"><?php echo e(__('setting.Targeting Cookies')); ?></span>
                                            </label>
                                            <i class="far fa-question-circle ms-2" style="cursor: pointer"
                                               onclick="displayCookieSettingDetails(this)"></i>
                                        </div>
                                        <p class="height-none cookie-setting-details my-3">
                                            <?php echo @$cookie->gdpr_targeting; ?>
                            ...
                            <div class="modal-footer">
                                <button type="button" onclick="setCookies();"
                                        class="theme_btn"><?php echo e(@$cookie->gdpr_confirm_choice_btn_text); ?>

                                </button>
                                <button type="button"
                                        class="theme_btn_outline"
                                        onclick="setCookies(1);"><?php echo e(@$cookie->gdpr_accept_all_btn_text); ?>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/components/footer-cookie.blade.php ENDPATH**/ ?>