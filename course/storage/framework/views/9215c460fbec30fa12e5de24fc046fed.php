    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#form_data_id').on('submit', function (event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('company_information_update')); ?>",
                    method: "POST",
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/admin/web/sampad.me/public_html/course/Modules/Setting/Resources/views/page_components/script.blade.php ENDPATH**/ ?>