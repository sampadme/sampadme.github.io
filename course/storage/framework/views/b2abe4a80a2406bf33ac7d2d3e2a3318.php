                    ...
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-5 text-end">
                                <a target="_blank" href="<?php echo e(route('becomeInstructor')); ?>"
                                   class="primary-btn small fix-gr-bg w-fit float-end"> <span
                                        class="ti-eye pe-2"></span> <?php echo e(__('student.Preview')); ?> </a>
                            </div>
                        </div>
                                    ...
                                    <table id="lms_table" class="table Crm_table_active3">
                                        ...
                                        <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(ucfirst(str_replace('_',' ',$setting->section))); ?></td>
                                                    ...
                                                    <div class="dropdown CRM_dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right"
                                                            ...
                                                            <a href="#" data-bs-toggle="modal"
                                                               data-bs-target="#editSetting<?php echo e(@$setting->id); ?>"
                                                               class="dropdown-item"
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/sampad.me/public_html/course/Modules/FrontendManage/Resources/views/becomeInstructor.blade.php ENDPATH**/ ?>