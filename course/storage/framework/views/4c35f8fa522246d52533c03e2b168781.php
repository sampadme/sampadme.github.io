...
<div class="container-fluid g-0" id="main-nav-for-chat">
    <div class="row">
        <div class="col-lg-12 p-0">
            <div
                class="header_iner d-flex justify-content-end justify-content-lg-between align-items-center <?php echo e($user->sidebar==1 ? '' : 'full-width'); ?>">
                <?php
                ...
                <div class="d-flex align-items-center">
                    <?php if($user->sidebar!=1): ?>
                        <a class="large_logo   header_logo_area" href="<?php echo e(url('/')); ?>">
                            ...
                            <form action="#">
                                <div class="search_field">
                                    <input type="text" class="form-control primary-input input-left-icon"
                                           placeholder="<?php echo e(__('common.Search')); ?>" id="search"
                ...
                <div class="header_right d-flex justify-content-between align-items-center">
                    <?php echo $__env->make('partials.timer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <select name="code" id="language_code"
                                ...
                                <?php $__currentLoopData = $LanguageList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e(route('changeLanguage',$language->code)); ?>"
                                            data-display="<?php echo e($language->code); ?>"
                                            <?php if($user->language_code == $language->code): ?> selected <?php endif; ?>><?php echo e($language->native); ?></option>
                    ...
                    <ul class="header_notification_warp d-flex align-items-center gap-25">
                        ...
                        <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="<?php echo e(__('common.Visit Website')); ?>"
                        ...
                        <li class="d-flex" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="<?php echo e(__('common.Toggle Sidebar')); ?>" data-bs-custom-class="tooltip-zindex">
                            <button class="nav-layout-toggler   p-0">
                                <?php if($user->sidebar!=1): ?>
                                    <a href="<?php echo e(route('changeMenuStyle','sidebar')); ?>">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e(route('changeMenuStyle','topbar')); ?>">
                        ...
                        <li class="d-none d-sm-block" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="<?php echo e(__('common.Toggle Theme')); ?>" data-bs-custom-class="tooltip-zindex">
                            <div class="theme-toggler" id="">
                                <div class="icons">
                                    <?php if($user->dark_mode==1): ?>
                                        <a href="<?php echo e(route('changeDarkMode','light')); ?>">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('changeDarkMode','dark')); ?>">
                        ...
                        <li class="scroll_notification_list" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            title="<?php echo e(__('common.Notifications')); ?>" data-bs-custom-class="tooltip-zindex">
                            <a class="pulse theme_color bell_notification_clicker show_notifications" href="#">
                                ...
                                <!--/ bell   -->
                                <span
                                    class="notificationCount notification_count"><?php echo e(translatedNumber($user->unreadNotifications->count())); ?></span>
                                ...
                                <div class="nofity_footer">
                                    ...
                                    <?php if(permissionCheck('notification_setup_list')): ?>
                                        <div class="submit_button text-center ">
                                            <a href="<?php echo e(route('notification_setup_list')); ?>"
                                               class="pt-3" style="    color: #415094!important;">
                                                <i class="fas fa-cog"></i>
                                                <?php echo e(__('setting.Notification')); ?> <?php echo e(__('setting.Setup')); ?></a>
                        ...
                        <?php if(permissionCheck('communication.PrivateMessage')): ?>
                            <li class="scroll_notification_list" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                title="<?php echo e(__('common.Message')); ?>" data-bs-custom-class="tooltip-zindex">
                                <a class="pulse theme_color"
                                   href="<?php echo e(route('communication.PrivateMessage')); ?>">
                                    ...
                                    <span class="notification_count"><?php echo e(translatedNumber($totalMessage)); ?>  </span>
                    ...
                    <div class="profile_info">
                        <div class="profileThumb"
                             style="background-image: url('<?php echo e(getProfileImage($user->image,$user->name)); ?>')"></div>
                        ...
                        <div class="profile_info_iner">
                            ...
                            <div class="profile_info_details">
                                ...
                                <a href="<?php echo e(auth()->user()->username?route('profileUniqueUrl',auth()->user()->username):''); ?>"
                                   class="px-4 py-2">
                                    <!-- <i class="ti-user"></i> -->
                                    ...
                                    <span><?php echo e(__('common.View Profile')); ?> </span>
                                </a>
                                <a href="<?php echo e(route('users.settings')); ?>" class="px-4 py-2">
                                ...
                                <?php if(isModuleActive('UserType')): ?>
                                    <?php $__currentLoopData = auth()->user()->userRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <a href="<?php echo e(route('usertype.changePanel',$role->id)); ?>" class="px-4 py-2">
                                            <!-- <i class="ti-link"></i> -->
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                                <?php if((isModuleActive('LmsSaas') && $user->is_saas_admin==1) || isModuleActive('LmsSaasMD') && $user->is_saas_admin==1): ?>
                                    <a href="<?php echo e(route('saas_panel')); ?>" class="px-4 py-2" onclick="event.preventDefault();
                                ...
                                <div class="log-out-link-container">
                                    <a href="<?php echo e(route('logout')); ?>" class="px-4 py-2 log-out-link" onclick="event.preventDefault();
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/backend/partials/menu.blade.php ENDPATH**/ ?>