<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/instractor/2.jpg')); ?>"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="become-instructor-content">
                        <h3 class="fw-500"><?php echo e(@$homeContent->become_instructor_title); ?></h3>
                        <p class="mb-4"><?php echo e(@$homeContent->become_instructor_sub_title); ?></p>
                        <a href="<?php echo e(route('becomeInstructor')); ?>" class="theme-btn bg-white justify-content-center">Join
                            Now</a>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_become_instructor_section_v2.blade.php ENDPATH**/ ?>