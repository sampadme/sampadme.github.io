<div data-type="component-text"
     data-preview="<?php echo e(!function_exists('themeAsset')?'':themeAsset('img/snippets/preview/blog/2.jpg')); ?>"
                ...
                <div class="col-md-12">
                    <div class="section-subtitle v2">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>
                                <h3 class="mb-0 text-white"> <?php echo e(@$homeContent->article_title); ?></h3>
                            </div>
                            <div class="section-subtitle-action">
                                <a href="<?php echo e(url('blog')); ?>" class="theme-btn bg-white ms-2">All Post</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/frontend/infixlmstheme/snippets/components/_blog_section_v2.blade.php ENDPATH**/ ?>