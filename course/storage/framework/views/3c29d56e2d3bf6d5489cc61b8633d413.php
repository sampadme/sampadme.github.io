<script>
    ...
    Amaz.data = {
        ...
        appUrl: '<?php echo e(url("/")); ?>',
        fileBaseUrl: '<?php echo e(url("/")); ?>' + '/'
    };
    Amaz.uploader = {
        data: {
            selectedFiles: [],
        ...
        amazUppy: function () {
            if ($(".AmazUppyDragDrop").length > 0) {
                ...
                uppy.use(Uppy.XHRUpload, {
                    endpoint: '<?php echo e(route('setting.media-manager.store')); ?>',
                    fieldName: "file",
                    formData: true,
                    headers: {
                ...
                uppy.on("upload-success", function () {
                    Amaz.uploader.getAllUploads(
                        "<?php echo e(route('setting.media-manager.get_files_for_modal')); ?>"
                    );
                });
            }
        },
        ...
        updateFileHtml: function (array) {
            let fileText = "";
            if (array.length > 1) {
                fileText = '<?php echo e(__('setting.File Selected')); ?>';
            } else {
                fileText = '<?php echo e(__('setting.Files Selected')); ?>';
            }
        ...
        updateUploaderFiles: function () {
            ...
            setTimeout(function () {
                ...
                if (data.length > 0) {
                    ...
                    $("#all_files_div").html(
                        '<div class="align-items-center d-flex justify-content-center w-100"><div class="text-center"><h3><?php echo e(trans('common.No files found')); ?></h3></div></div>'
                    );
                }
        ...
        inputSelectPreviewGenerate: function (elem) {
            ...
            if (Amaz.uploader.data.selectedFiles.length > 0) {
                $.post(
                    "<?php echo e(route('setting.media-manager.get_media_by_id')); ?>",
                    ...
                    function (data) {
                        ...
                        if (data.length > 0) {
                            ...
                            for (let i = 0; i < data.length; i++) {
                                ...
                                if (data[i].type == 'image') {
                                    if (data[i].storage == 'local') {
                                        $('#show_path').text('<?php echo e(url('')); ?>' + '/' + data[i].file_name);
                                    ...
                                    imag = "<?php echo e(asset( '/')); ?>" + "public/preview/" + data[i].type + ".png";
                                }
...
<?php /**PATH /home/admin/web/sampad.me/public_html/course/resources/views/backend/partials/media_script.blade.php ENDPATH**/ ?>