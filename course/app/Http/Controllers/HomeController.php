...
class HomeController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        try {
            ...
            $payment_statistics['month'] = Carbon::now()->translatedFormat('F');
            $payment_statistics['year'] = translatedNumber(Carbon::now()->format('Y'));
...
//test end
            ...
            return view('dashboard', $data, compact('badges', 'recentEnroll', 'courshEarningM_onth_name', 'courshEarningMonthly', 'payment_statistics', 'enroll_day', 'enroll_count', 'course_overview', 'allCourses', 'students'));
