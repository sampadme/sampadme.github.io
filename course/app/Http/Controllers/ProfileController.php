                    ...
                    if (isset($document['document_name']) && $document['document_name']) {
                        ...
                        if ($from == 'frontend') {
                            ...
                            if (isset($document['document_image'])) {
                                $userDoc->document = $this->generateLink($document['document_image'], $userDoc->id, get_class($userDoc), 'document');
                            }
                        }
                ...
                foreach ($request->document_name as $key => $document) {
                    ...
                    if ($from == 'frontend') {
                        ...
                        if (isset($request->document_image[$key])) {
                            $userDoc->document = $this->generateLink($request->document_image[$key], $userDoc->id, get_class($userDoc), 'document');
                        }
                    }
