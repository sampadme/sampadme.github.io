...
class PaymentController extends Controller
{
    ...
    public function emailNotification($checkout_info, $cart, $gateWayName)
    {
        ...
        $this->sendNotification('Appointment_Enroll_Instructor', $cart->instructor, [
            [
        ...
        $this->sendNotification('Appointment_Enroll_Admin', $cart->instructor, [
            'time' => \Illuminate\Support\Carbon::now()->translatedFormat('d-M-Y ,s:i A'),
            'timeSlot' => $timeSlot,
            'topic' => $topic,
        ...
        $this->sendNotification('Appointment_Enroll_Payment', $cart->student, [
            'time' => \Illuminate\Support\Carbon::now()->translatedFormat('d-M-Y ,s:i A'),
            'timeSlot' => $timeSlot,
            'topic' => $topic,
