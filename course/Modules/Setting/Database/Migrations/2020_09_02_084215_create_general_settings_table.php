    ...
    public function up()
    {
        ...
        DB::table('general_settings')->insert([
            [
                ...
                'footer_copy_right' => 'Copyright © 2021 InfixLMS. All rights reserved | Made By  <a href="https://aorasoft.com" target="_blank"><span style="color:#D12053">CodeThemes</span></a>',
                'created_at' => now(),
                'updated_at' => now(),
            ]
        ]);
