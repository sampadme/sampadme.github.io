                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="primary_input mb-15">
                                    ...
                                    <select name="courses[]" id="menu_courseInput" class="primary_multiselect mb-15 e1"
                                            multiple>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="primary_input mb-15">
                                    ...
                                    <select name="quiz[]" id="menu_quizInput" class=" primary_multiselect mb-15 e1"
                                            multiple>
                            ...
                            <div class="col-lg-12">
                                <div class='input-effect'>
                                    <input class='primary-input form-control' type='text' id="tTitle" name='title'
                                           autocomplete='off'>
                                    <label>@lang('common.Title')<span class="required_mark">*</span></label>
