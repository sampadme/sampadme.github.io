                                                            ...
                                                            @if ($lesson->is_quiz==1)
                                                                @foreach ($lesson->quiz as $quiz_key=> $quiz)
                                                                    <span class="flex-fill"> <i
                                                                            ...
                                                                            class="serial">{{$key+1}}</span>. {{@$quiz->title}} [{{$lesson->is_lock==0?'Unlock':'Lock'}}]</span>
                                                            ...
                                                            @else
                                                                ...
                                                                <div class="dropdown CRM_dropdown">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        {{--
                                                                                   if org not
                                                                                   <a href="{{route('lesson.files',$lesson->id)}}"
                                                                                   --}}
                                                                        @if(isModuleActive('Org') && selfHosted($lesson->host) && !empty($lesson->org_material_id))
                                                                            <a href="{{route('org.material.files',$lesson->org_material_id)}}"
                                                                               type="button"
                                                                               class="dropdown-item btn-modal"
                                                                               data-container="#commonModal"
                                                                               type="button">{{__('common.Version Management')}}</a>
