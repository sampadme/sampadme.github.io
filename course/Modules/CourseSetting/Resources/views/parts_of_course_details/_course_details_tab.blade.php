    ...
    <div class="white-box  ">
        <form action="{{ route('AdminUpdateCourse') }}" method="POST"
            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 mb-25">
                                    <label class="primary_checkbox d-flex mr-12">
                                        ...
                                        <span
                                            class="checkmark me-2"></span>{{ __('courses.Compulsory') }}
                                    </label>
                                </div>
                                <div class="col-md-4 col-sm-6 mb-25">
                                    <label class="primary_checkbox d-flex mr-12">
                ...
                @endif
                <div
                    class="{{ $required_type ? 'col-xl-4' : 'col-xl-6' }} dripCheck"
            ...
            <div class="col-xl-12 p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 mt-25">
                        <label>{{_trans('courses.Access Limit')}} {{_trans('courses.In Days')}}
