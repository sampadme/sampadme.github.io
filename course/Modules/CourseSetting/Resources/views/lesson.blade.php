                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="input-effect">
                                                <label>{{__('common.Duration')}} ({{__('common.In Minute')}})
                                                    <span class="required_mark">*</span></label>
                                                <input
                                                    class="primary_input_field name{{ $errors->has('chapter_name') ? ' is-invalid' : '' }}"
                                            ...
                                            <div class="input-effect">
                                                <label>{{__('courses.Video URL')}} <span class="required_mark">*</span></label>
                                                <input
                                            ...
                                            <div class="input-effect">
                                                <label>{{__('common.Description')}} <span class="required_mark">*</span></label>
                                                <input
