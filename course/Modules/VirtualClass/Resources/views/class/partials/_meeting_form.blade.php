        ...
        <div class="add-visitor">
                        ...
                        <div class="row mt-20">
                            <div class="col-lg-12">
                                <div class="primary_input  mb-25">
                                    <label class="primary_input_label"> {{ __('virtual-class.Title') }} <span
                        ...
                        <div class="row mt-20">
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    ...
                                    <textarea class="  form-control" cols="0"
                                              rows="4"
            ...
            <div class="row mt-25 ">
                ...
                @if(isModuleActive('Org'))
                    <div class="col-xl-4 col-md-6">
                        <div class="primary_input  mb-25">
                            <label class="primary_input_label"> {{__('courses.Required Type')}} </label>
            ...
            <div class="row mt-20">
                ...
                @php
                    ...
                    $recurring_days=isset($class) ? $class->recurring_days : old('recurring_days');
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="row">
                        <div class="col-lg-12">
                            <label>@lang('virtual-class.Recurring')</label>
                        </div>
                        <div class="col-lg-12  d-flex mt-2">
                            <div class="col-md-4">
                                <label for="type_1" class="primary_checkbox d-flex mr-12 is_recurring">
                            ...
                            <div class="col-md-4">
                                <label for="type_2" class="primary_checkbox d-flex mr-12 is_recurring">
                ...
                <div class="col-xl-8 col-md-6 mt-20 recurrence_section  {{$is_recurring==1 ? '' : 'd-none'}}">
                    <div class="row">
                        <div class="col-lg-6">
                            <label class="primary_input_label"
                        ...
                        <div class="col-lg-6">
                            <label class="primary_input_label" for="">{{__('virtual-class.Type')}} <span
                                    class="required_mark">*</span></label>
                            <select
                        ...
                        @foreach ($days as $key=>$day)
                            ...
                            <label for="day{{$key}}" class="primary_checkbox d-flex mr-12 mb-2 ">
                                <input type="checkbox" class="common-checkbox" id="day{{$key}}"
                                       ...
                                       value="{{ $key }}">
                                <span class="checkmark me-2"></span>{{trans('virtual-class.'.$day) }}</label>
                    ...
                    <div class="col-lg-4">
                        <div class="primary_input  mb-25">
                            <label class="primary_input_label"> {{ __('virtual-class.Capacity') }}
                                <small>[{{__('common.Note: 0 or empty means unlimited')}}]</small></label>
                            <input
                ...
                <div class="row mt-20">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="row">
                            <div class="col-lg-12">
                                <label>{{ __('virtual-class.Show Record') }}</label>
                            </div>
                            <div class="col-lg-12  d-flex mt-2">
                                <div class="col-md-4">
                                    <label for="show_record_1" class="primary_checkbox d-flex mr-12 is_recurring">
                                        <input type="radio" class="common-checkbox" id="show_record_1"
                                               name="show_record"
                                               value="1"
                                ...
                                <div class="col-md-4">
                                    <label for="show_record_2" class="primary_checkbox d-flex mr-12 is_recurring">
                                        <input type="radio" class="common-checkbox" id="show_record_2"
                                               name="show_record"
                                               value="0"
                                            {{ isset($class) && $class->show_record != 1 ? 'checked' : '' }}
                                            {{!isset($class)? 'checked' : ''}}
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="primary_input  mb-25">
                            <label class="primary_input_label">{{ __('virtual-class.Validity Days After Record') }}
                                <small>
