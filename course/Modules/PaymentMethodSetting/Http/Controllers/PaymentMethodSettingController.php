...
//        }
   ...
   return $ccavenue->prepare($payment_info, $data['test_amount']);
//            return view('ccavenue::payment_form', compact('encrypt_key'));
 ...
 return back();
    ...
    {
//        $pay = new RazerMSPlanController();
//        $pay->getPlanList();

        $pay = new RazerMSController();
        $result = $pay->recurring();
