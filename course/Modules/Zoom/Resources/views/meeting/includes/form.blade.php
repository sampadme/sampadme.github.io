        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12">
                            <div class="input-effect">
                                ...
                                <label>{{__('zoom.Topic')}} <span class="required_mark">*</span></label>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-6">
                            <label>{{__('zoom.Date Of Class')}} <span class="required_mark">*</span></label>
                        ...
                        <div class="col-lg-6">
                            <label>{{__('zoom.Time Of Class')}} <span class="required_mark">*</span></label>
                            <input
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label>{{__('zoom.Class Duration')}}<span class="required_mark">*</span></label>
                                    <span class="focus-border"></span>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12">
                            <div class="input-effect">
                                ...
                                <label>{{__('zoom.Password')}}<span class="required_mark">*</span></label>
                                <span class="focus-border"></span>
