        ...
        @foreach($result as $course)
            <div class="col-lg-4 col-sm-6 d-flex">
                <div class="course-item w-100">
                    ...
                    <div
                        class="course-item-footer bg-primary d-flex align-items-center justify-content-between flex-wrap">
                        <div class="d-flex align-items-center">
                            @if(showEcommerce())
                                ...
                                @if (@$course->discount_price!=null)
                                    <del class="ms-2 fw-normal">{{getPriceFormat($course->discount_price)}}</del>
                                @endif
                            @endif
                        </div>
                        <div>
