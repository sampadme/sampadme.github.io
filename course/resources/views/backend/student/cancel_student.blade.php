                            ...
                            <div class="col-12">
                                <div class="box_header common_table_header">
                                    <div class="main-title d-md-flex">
                                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('frontend.Refund & Cancellation')}} {{__('common.List')}}</h3>
                                        ...
                                        <div class="">
                                            <table id="lms_table" class="table Crm_table_active3">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col">{{__('common.Approved')}}
                                                        /{{__('common.Reject')}} {{__('common.Date')}} </th>
